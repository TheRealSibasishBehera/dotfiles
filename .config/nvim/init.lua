...
-- Ensure Go is in PATH for LSP and tools
vim.env.PATH = vim.env.HOME .. '/.local/go/bin:' .. vim.env.HOME .. '/go/bin:' .. vim.env.PATH
...
-- Global virtual text toggle (available immediately)
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { '<leader>d', group = '[D]efinition/Peek' },
        { '<leader>l', group = '[L]azy' },
        { ']', group = 'Next Treesitter Objects' },
        { '[', group = 'Previous Treesitter Objects' },
      },
    },
  },
  ...
  },
  {
    ...
    config = function()
      ...
      vim.diagnostic.config {
        ...
        virtual_text = false, -- <--- This disables ALL inline diagnostic text
        ...
        update_in_insert = false, -- <--- Optional: disables updates while typing
      }
