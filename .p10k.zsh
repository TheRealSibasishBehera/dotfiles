# Generated by Powerlevel10k configuration wizard on 2025-04-16 at 10:46 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    vcs                     # git status (moved from left)
  ...
  typeset -g POWERLEVEL9K_DIR_MIN_COMMAND_COLUMNS_PCT=65
